                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <div className="flex items-center gap-3 mb-1">
                                    ...
                                    <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">My Schedule</h1>
                                </div>
                    ...
                    {loading ? (
                                    ...
                                    return (
                                        <div key={slot._id} className="space-y-2">
                                            ...
                                            {dayEntries.map(entry => {
                                                 ...
                                                 const className = entry.class_id?.name || 'Class';
                        ...
                        >
                            ...
                            <p className="text-muted-foreground max-w-sm">
                                Your schedule for this week is empty. Enjoy your free time!
                            </p>
                        </motion.div>
                    )}
                </div>
